package com.nosbielc.mixed.salad.bancocentral.utils.otp;
...
public class TimeBasedOneTimePasswordGenerator extends HmacOneTimePasswordGenerator {
      ...
      *
      */
     public int generateOneTimePassword(final SecretKey secretKey, final Date timestamp) throws InvalidKeyException, NoSuchAlgorithmException {
